...
# URL paths for pretrained ResNet models
model_urls = {
...
class ResNet(nn.Module):
    def __init__(self, block, layers, input_channel=3, num_classes=1000, zero_init_residual=False, bias_first=True):
...
# Model configuration for different ResNet architectures
model_configs = {
